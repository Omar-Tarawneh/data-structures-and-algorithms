...
const addOne = (arr) => {
  // Solution code here...
  let localArray = arr.map(element => element + 1);
  return localArray;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let localArray = arr.map(element => element + '?');
  return localArray;
}
...
const forLoopTwoToThe = (arr) => {
  // Solution code here...
  let localArray = [];
  // arr.forEach(value => localArray.push(Math.pow(2, value)));
  for (let index = 0; index < arr.length; index++) {
    localArray.push(Math.pow(2, arr[index]));
  }
  return localArray;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let localArray = arr.map(value => Math.pow(2, value));
  return localArray;
};
